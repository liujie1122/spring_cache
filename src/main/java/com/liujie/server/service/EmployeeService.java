package com.liujie.server.service;
...
public class EmployeeService {
     ...
     *
     */
//    @Cacheable(cacheNames = "emp",key = "#root.methodName+'['+#id+']'",unless = "#result == null")
...
//    @Cacheable(cacheNames = "emp",key = "#result.id")
    public Employee addEmp(Employee employee){
        ...
        employee.setLastName("Tom").setGender(1).setEmail("Tom_Email").setdId(1);
